...
def deep_check_chunk(url, timeout=5):
    """فحص عميق: تحميل مقطع فيديو حقيقي للتأكد من استقرار البث 100%"""
    try:
        ...
        with urllib.request.urlopen(req, timeout=timeout) as res:
            ...
            chunk = lines[0]
            chunk_url = urllib.parse.urljoin(url, chunk) if not chunk.startswith('http') else chunk
...
DEFAULT_SOURCES = {
    ...
    "-P1v9AE8ENv9y8MvmyNm": "https://nablusmix.live/channel/3",
